...
class Tarea {
    ...
    constructor(titulo, descripcion = "", estado = "pendiente", vencimiento = "", dificultad = "facil", id, creacion, ultimaEdicion) {
        ...
        this.Creacion = creacion !== null && creacion !== void 0 ? creacion : now;
        this.UltimaEdicion = ultimaEdicion !== null && ultimaEdicion !== void 0 ? ultimaEdicion : now;
    ...
    mostrar() {
        ...
        console.log(`Ultima edicion: ${(_a = this.UltimaEdicion) !== null && _a !== void 0 ? _a : ""}`);
